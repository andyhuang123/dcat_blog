...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection router
     ...
     * @property Grid\Column|Collection reade_num
     ...
     * @method Grid\Column|Collection router(string $label = null)
     ...
     * @method Grid\Column|Collection reade_num(string $label = null)
     ...
     * @property Show\Field|Collection router
     ...
     * @property Show\Field|Collection reade_num
     ...
     * @method Show\Field|Collection router(string $label = null)
     ...
     * @method Show\Field|Collection reade_num(string $label = null)
